...
/**
 * Created by ku on 2016/7/20.
 */
public class LoadMoreSwipe extends SwipeRefreshLayout implements AbsListView.OnScrollListener {
    ...
    public LoadMoreSwipe(Context context) {
        this(context, null);
    }

    public LoadMoreSwipe(Context context, AttributeSet attrs) {
        super(context, attrs);
        //表示触发事件的最小距离
