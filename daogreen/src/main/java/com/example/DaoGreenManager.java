...
public class DaoGreenManager {

    public static void main(String[] args) throws Exception {
        // 正如你所见的，你创建了一个用于添加实体（Entity）的模式（Schema）对象。
        // 两个参数分别代表：数据库版本号与自动生成代码的包路径。
        Schema schema = new Schema(1, "com.hz_project.entity");
...
//      schema.setDefaultJavaPackageDao("me.itangqi.dao");
        ...
        new DaoGenerator().generateAll(schema, "G:/HZ_Project/github/projectJudicial/app/src/main/java-gen");
    }
